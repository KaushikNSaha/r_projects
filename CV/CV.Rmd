...
work <- tribble(
  ...
  "Administrative Assistant (Remote)", "Oct, 2022", "Present", "Baeldung - EdTech Company", "Performing various Administrative work via online using Google Suites, Project Management Software - Jira, Marketing Automation Platform - DRIP, Online Course Platform - Teachable, Google Analytics"
)
